...
//--------------------------------//
    case data.client_read:
        ...
        //
        var new_entity = Event_Create_Entity(entity.object)
        //
...
//================================//
    case data.server_read:
        ...
        //
        Packet_Write(packet.entity_create_object,data.position,get_x,get_y,get_vector_direction,get_vector_speed)
        exit
        }
//--------------------------------//
    case data.server_write:
        ...
        var get_entity = Event_Create_Entity(entity.object)     
        //
...
//--------------------------------//
    default:
        {
        show("Error, no case! @packet_object_create@")
        }
    }
