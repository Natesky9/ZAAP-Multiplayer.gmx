...
//--------------------------------//
    case data.client_read:
        {
        //
        client_read_position(async_packet)
        var get_entity = client_read_u8()
        //
        var new_entity = Event_Create_Entity(entity.projectile)
        //
...
//================================//
    case data.server_read:
        ...
        //
        Packet_Write(packet.entity_create_projectile,data.position,get_x,get_y,get_vector_direction,get_vector_speed)
        exit
        }
//--------------------------------//
    case data.server_write:
        ...
        var get_entity = Event_Create_Entity(entity.projectile)     
        //
...
//--------------------------------//
    default:
        {
        show("Error, no case! @packet_projectile_create@")
        }
    }
