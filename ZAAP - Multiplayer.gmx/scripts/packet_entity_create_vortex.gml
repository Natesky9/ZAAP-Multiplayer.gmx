...
//================================//
    case data.server_read:
        ...
        //
        Packet_Write(packet.entity_create_vortex,data.position,get_x,get_y,get_vector_direction,get_vector_speed)
        exit
        }
//--------------------------------//
    case data.server_write:
        ...
        var get_entity = Event_Create_Entity(entity.vortex)     
        //
